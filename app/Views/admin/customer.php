            ...
            <div class="row">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    <div class="col-md-6 p-3">
                        <form method="POST" action="/admin/customers/<?php echo $user['id'] ?>">
                        <?= csrf_field(); ?>
                            <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" name="isinfluencer" type="checkbox" id="flexCheckChecked" value="1" <?php echo ($user['isinfluencer'] == '1') ? 'checked' : ''; ?>>
